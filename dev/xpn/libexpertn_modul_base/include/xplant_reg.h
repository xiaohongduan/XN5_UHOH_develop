...
xpn_register_var_init_pdouble( var_list, pPl->pBiomass->fRootWeight,"pPl.pBiomass.fRootWeight",0.0);\
xpn_register_var_init_pdouble( var_list, pPl->pBiomass->fStemWeight,"pPl.pBiomass.fStemWeight",0.0);\
xpn_register_var_init_pdouble( var_list, pPl->pBiomass->fLeafWeight,"pPl.pBiomass.fLeafWeight",0.0);\
xpn_register_var_init_pdouble( var_list, pPl->pBiomass->fFruitWeight,"pPl.pBiomass.fFruitWeight",0.0);\
...
xpn_register_var_init_pdouble( var_list, pPl->pCanopy->fGrainNum,"pPl.pCanopy.fGrainNum",0.0);\
